...
r = recipe_from_plain_english(text, profile, 'samples/test_datasets/sales_inconsistent_dates.csv', 'data/outputs/test_out.csv')
print('Recipe:', json.dumps(r.model_dump(), indent=2, ensure_ascii=False))
